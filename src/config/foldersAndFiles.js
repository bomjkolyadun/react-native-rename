...
export function foldersAndFiles(currentAppName, newName) {
  ...
  return [
    ...
    `macos/${nS_NewName}.xcodeproj/xcshareddata/xcschemes/${nS_CurrentAppName}.xcscheme`,
    `macos/${nS_CurrentAppName}Tests`,
    `macos/${nS_NewName}Tests/${nS_CurrentAppName}Tests.m`,
